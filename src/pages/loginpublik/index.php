          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-md-6 text-end mb-5">
                ...
                <form action="/login-action-publik" method="POST">
              ...
              <div class="col-md-6 text-end">
                ...
                <form action="/register-publik" method="POST" enctype="multipart/form-data">
                  <input type="text" class="form-control shadow-sm mb-3" name="namaUser" placeholder="Nama Lengkap" required>
                  <input type="text" class="form-control shadow-sm mb-3" name="nohandphone" placeholder="No Handphone" required>
                  ...
                  <input type="email" class="form-control shadow-sm mb-3" name="email" placeholder="Email" required>
                  <input type="file" class="form-control shadow-sm mb-3" name="foto" placeholder="Foto" required>
                  <input type="hidden" name="idRole" value="rol611f11be4a52a">
