...
<img class="img-fluid"src="../assets/image/Header kesbangpol Revisi ke 5-01.png" alt="header" style="height: 200; width: 1284;">
    ...
    <h3 class="d-flex justify-content-center" style="color: #1a8cff; ">Di Situs Resmi Kantor Kesatuan Bangsa dan Politik Kota Cimahi</h3>
        ...
        <div class="col d-flex justify-content-center">
        <a><img src="../assets/icon/Organisasi terdaftar.png" alt="Organisasi Terdaftar"></a> 
        </div>
        <div class="col d-flex justify-content-center">
        <a><img src="../assets/icon/Forum orsospol.png" alt="Forum Orsospol"></a>
        </div> 
        <div class="col d-flex justify-content-center">
        <a><img src="../assets/icon/Icon Layanan Dashboard.png" alt="Layanan"></a> 
        </div>
        <div class="col d-flex justify-content-center">
        <a><img src="../assets/icon/Contact us.png" alt="Hubungi Kami"></a>   
            </div>
        </div>
    </div>
