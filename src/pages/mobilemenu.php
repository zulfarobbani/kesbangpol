  ...
  <div class="row">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="http://sipt.kemendag.go.id" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/sipt.png" class="mt-1" height="30px">
		<span class="text-start" style="font-size:12px;padding-left: 100px;"><b>Sistem Informasi </b><br>Perizinan Terpadu</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://bpbj.sukabumikota.go.id" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="https://bpbj.sukabumikota.go.id/assets/images/frontend/link/pjl7jtntsv.png" class="mt-1" height="30px">
		<span class="text-start" style="font-size:9px;padding-left: 100px;"><b>Tim Evaluasi dan</b><br>Pengawasan Realisasi Anggaran</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="http://www.simbah.co.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
		...
		<span class="text-start" style="font-size:9px;padding-left: 100px;"><b>Sistem Informasi</b><br>Pengelolaan Bank Sampah</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://library.cimahikota.go.id" class="btn btn-sm btn-outline-secondary d-flex mb-2">
		...
		<span class="text-start" style="font-size:12px;padding-left: 100px;"><b>Aplikasi Perpustakaan</b></span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://pesduk.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="/assets/image/pesduk.png" class="mt-1" height="20px" style="filter: invert(100%);width:100%;">
		<span class="text-start" style="font-size:12px;padding-left: 100px;"><b>Pesan Singkat</b><br>Penduduk</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://epad.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
		...
		<span class="text-start" style="font-size:12px;padding-left: 100px;"><b>Sistem Informasi</b><br>Pendapatan</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative;" href="http://simantra.ntbprov.go.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="/assets/image/mantra.png" class="ms-1 me-2 mt-1" height="20px">
		<span class="text-start" style="font-size:9px;padding-left: 100px;"><b>Aplikasi Manajemen Integrasi</b><br>dan Pertukaran Data</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="http://silatik.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        ...
        <span class="text-start w-100" style="font-size: 13px;padding-left: 50px;"><b>Sistem Informasi</b><br>Layanan TIK</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://jdihn.go.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/jdihn.png" class="ms-1 mt-1" height="25px">
		<span class="text-start" style="font-size:9px;padding-left: 100px;"><b>Jaringan Dokumentasi</b><br>Informasi Hukum Nasional</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://chimasistaker.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/cimasistaker.png" height="40px">
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://lpse.jabarprov.go.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/lapse.png" class="mt-1 ms-2" height="30px">
		<span class="text-start" style="font-size:10px;padding-left: 100px;"><b>Layanan Pengadaan</b><br>Secara Elektronik</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="#" class="btn btn-sm btn-outline-secondary d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://sirup.lkpp.go.id/sirup/ro/penyedia/kldi/D111" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="/assets/image/sirup1.png" class="mt-1" height="20px">
		<span class="text-start" style="font-size:10px;padding-left: 100px;"><b>Sistem Informasi</b><br>Rencana Umum Pengadaan</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://bkpsdmd.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
		...
		<span class="text-start" style="font-size:11px;padding-left: 100px;"><b>Sistem Informasi</b><br>Kinerja Pegawai</span>
      </a>
    </div>
    <div class="col-12" id="pict">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://sipkd.jabarprov.go.id/" target="_blank" class="btn btn-sm btn-outline-secondary d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/sipkd.png" class="mt-1" height="30px" style="filter: invert(30%);">
		<span class="text-start" style="font-size:11px;padding-left: 100px;"><b>Sistem Informasi</b><br>Pengelolaan Keuangan Daerah</span>
      </a>
    </div>
    ...
    <div class="p-3 mb-5">
      ...
      <div class="border border-secondary rounded">
        <div class=" text-muted col-12 text-start py-3 mx-2" id="pict">
          <div class="row">
            <?php foreach ($kontakDarurat as $key => $value) { ?>
              <div class="col-5">
                <span style="font-size:0.7rem;"><?= $value['namaKontakdarurat'] ?></span>
              </div>
              <div class="col-2">
                <span style="font-size:0.7rem;">:</span>
              </div>
              <div class="col-5">
                <span style="font-size:0.7rem;"><?= $value['isiKontakdarurat'] ?></span>
              </div>
            <?php } ?>
          </div>
        </div>
