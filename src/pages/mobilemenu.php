...
<div class="col py-3 pe-4 text-white border-white">
  <?php if ($idRole != null) { ?>
  ...
  <div class="row">
    <h5 class="my-4 text-center text-white" id="layanankesbangpol">Layanan<br><b>KESBANGPOL</b></h5> 
    <div class="col-12">
      <a href="/layanan/pendataan" class="btn btn-sm btn-outline-light d-flex mb-2 py-2">
        <span class="material-icons-outlined align-middle">person_add_alt_1</span>&nbsp;&nbsp;
        <span style="font-size:12px;">Pendataan Orsospol</span>
      </a>
    </div>
    <div class="col-12">
      <a href="/layanan/permohonan-hibah" class="btn btn-sm btn-outline-light d-flex mb-2 py-2">
        <span class="material-icons-outlined align-middle">volunteer_activism</span>&nbsp;&nbsp;
        <span style="font-size:12px;">Permohonan Hibah</span>
      </a>
    </div>
    <div class="col-12">
      <a href="/layanan/permohonan-penelitian" class="btn btn-sm btn-outline-light d-flex mb-2 py-2">
    ...
    <h5 class="text-white my-4 text-center" id="layananpublik">Tautan Layanan Publik<br><b>Kota Cimahi</b></h5>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="http://sipt.kemendag.go.id" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/sipt.png" class="" height="40px">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://bphtb.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://bpbj.sukabumikota.go.id" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://uptpasar.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>UPT PASAR&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="http://www.simbah.co.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/simbah.png" class="" height="40px">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://ppid.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>PPID</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://library.cimahikota.go.id" class="btn btn-sm btn-outline-light d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://sip.cimahikota.go.id/be/index" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>eSIP</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://pesduk.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="/assets/image/pesduk.png" class="" height="30px" style="filter: invert(100%);width:100%;">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="http://siempus.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>Si-Empus</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://epad.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/Epad.png" class="" height="40px" style="filter: invert(100%);">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://pmks.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://sipd.kemendagri.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://rsudcibabat.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:11px;padding-left: 42px;"><b>RSUD CIBABAT ONLINE</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative;" href="http://simantra.ntbprov.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="/assets/image/mantra.png" class="ms-1 me-2" height="30px">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://disdukcapil.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://webmail.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://e-reporting.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>e-Reporting v.2</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="http://silatik.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="#" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>Financial Dashboard</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://www.online-pajak.com/kantor-pajak/kpp-pratama-cimahi" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://jdihn.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/jdihn.png" class="ms-1" height="40px" width="110px">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://sid.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>SID</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://chimasistaker.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/cimasistaker.png" height="40px" width="120px">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://arsipstatis.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>ARSIP STATIS</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://lpse.jabarprov.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://data.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/copendata.png" class="" height="40px" style="filter: invert(60%);">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="http://103.18.117.33/stats/list/id/549/type/Online" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>SIMKESBANG</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://silima.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://ukpbj.depok.go.id/simanda/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
    ...
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://sirup.lkpp.go.id/sirup/ro/penyedia/kldi/D111" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="/assets/image/sirup1.png" class="" height="30px" width="110px">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://smartcity.cimahikota.go.id/cctv" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="https://bappenda.cimahikota.go.id/logo/cimahi.gif" class="ms-1 me-2" height="30px">
        <span class="text-start" style="font-size:12px;padding-left: 42px;"><b>CCTV</b><br>Kota Cimahi</span>
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://bkpsdmd.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 10%;" src="/assets/image/sikacii.png" class="" height="40px" style="filter: invert(30%);">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://simrenda.cimahikota.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
        <img style="position: absolute;top: 20%;" src="/assets/image/simrenda.png" class="" height="35px" style="filter: invert(60%);">
      </a>
    </div>
    <div class="col-12" id="pict">
      <a style="height: 52px;box-sizing: border-box;padding-left: 15px;position:relative" href="https://sipkd.jabarprov.go.id/" target="_blank" class="btn btn-sm btn-outline-light d-flex mb-2">
