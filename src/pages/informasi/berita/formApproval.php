                ...
                <div class="card mt-5">
                    ...
                    <div class="modal fade" id="approvalModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h6 class="modal-title" id="exampleModalLabel">Approval Berita</h6>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                </div>
                                <div class="modal-body">
                                    <form action="" method="post" enctype="multipart/form-data" class="approvalForm">
                                        <div class="mb-3">
                                            <label for="exampleFormControlInput1" class="form-label"><b>Judul Berita</b></label>
                                            <input type="text" name="namaBerita" class="form-control judulBerita" disabled>
                                        </div>
                                        <div class="mb-3">
                                            <div class="row">
                                                <div class="col-12 mb-3">
                                                    <b>Status Berita</b>
                                                    <p class="statusBerita"></p>
                                                </div>
                                                <div class="col-12 mb-3">
                                                    <b>Cover Berita</b>
                                                    <p>
                                        ...
                                        <div class="d-flex">
                                            <button type="submit" style="margin-right:20px;" class="btn btn-primary" name="approvalBerita" value="1">Setujui</button>
                                            <button type="submit" class="btn btn-danger" name="approvalBerita" value="2">Tidak di setujui</button>
                                        </div>
                                    </form>
                                </div>
                                <div class="modal-footer">
        ...
        $(document).ready(function() {
            ...
            editModal.addEventListener('show.bs.modal', function(event) {
                ...
                $.ajax({
                    ...
                    editForm.setAttribute('action', '/informasi-kesbangpol/berita/' + idBerita + '/approval')
                    ...
                    var statusBerita = editModal.querySelector('.statusBerita')
                    statusBerita.innerHTML = response.data.approvalBerita == 2 ? 'Berita belum di sertujui' : 'Berita disetujui'
                })
            })
