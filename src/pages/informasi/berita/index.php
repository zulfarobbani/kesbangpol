          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <div class="row justify-content-center">
                ...
                <div class="col mb-3">
                  <a href="" class="twitter" target="_blank"><img src="/assets/icon/sosmed/twitter.svg" class="w-50 d-block mx-auto" alt=""><p class="text-dark" style="font-size: 12px"><br>Twitter</p></a>
                </div>
                <div class="col mb-3">
                  <a href="" class="whatsapp" target="_blank"><img src="/assets/icon/sosmed/whatsapp.svg" class="w-50 d-block mx-auto" alt=""><p class="text-dark" style="font-size: 12px"><br>Whatsapp</p></a>
                </div>
                <div class="col mb-3">
                  <a href="" class="telegram" target="_blank"><img src="/assets/icon/sosmed/telegram.svg" class="w-50 d-block mx-auto" alt=""><p class="text-dark" style="font-size: 12px"><br>Telegram</p></a>
                </div>
                <div class="col mb-3">
                  <a href="" class="instagram" target="_blank"><img src="/assets/icon/sosmed/instagram.svg" class="w-50 d-block mx-auto" alt=""><p class="text-dark" style="font-size: 12px"><br>Instagram</p></a>
                </div>
