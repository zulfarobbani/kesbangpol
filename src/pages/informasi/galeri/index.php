                    ...
                    <div class="kartu__content">
                      ...
                      <div class="row">
                        ...
                        <div class="col-6 p-0 hstack">
                          <a href="/informasi/galeri/<?= $values['idGallery'] ?>/detail" class="btn btn-sm btn-outline-danger d-inline ms-auto">Show more <i class="fas fa-long-arrow-alt-right"></i></a>
                        </div>
                      </div>
