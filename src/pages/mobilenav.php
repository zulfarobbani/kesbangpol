  ...
  <div class="d-flex justify-content-between">
    <div class="align-self-center">
      <a href="/informasi/berita">
        <span class="material-icons-outlined menumobile ms-2">
          info
        </span></a>
    </div>

    <div class="align-self-center">
      <a href="/organisasi-terdaftar/ormas" class="">
        <span class="material-icons-outlined menumobile">
          groups
        </span>
      </a>
    </div>
    ...
    <span class="material-icons-outlined menumobile bg-danger text-white py-1 px-2 my-3 rounded-2" id="open-button">
      menu
    </span>

    <div class="align-self-center">
      <span class="material-icons-outlined menumobile text-white" id="open-button2">
        apps
      </span>
    </div>

    <div class="align-self-center">
      <a href="#" data-bs-toggle="modal" data-bs-target="#hubungiKami" class=""><span class="material-icons-outlined menumobile me-2">
          support_agent
        </span></a>
    </div>
