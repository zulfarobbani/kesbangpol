    ...
    <div class="collapse navbar-collapse" id="navbarNav" style="height: 55px;">
      <div class="container-fluid d-flex justify-content-center" style="height: 55px;">
        <ul class="navbar-nav">
          ...
          <?php } ?>
          <?php if ($idRole == null) { ?>
            <li class="d-flex align-items-center nav-item <?= strpos($requestUri, 'login-orsospol') || strpos($requestUri, 'login-pegawai') ? 'nav-item-active' : '' ?> text-center px-3 py-1">
              <div class="container-fluid">
                <a class="nav-link dropdown-toggle <?= strpos($requestUri, 'login-orsospol') || strpos($requestUri, 'login-pegawai') ? 'nav-link-active' : '' ?>" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false" style="font-size: 12px;padding:0;">
                  <span class="material-icons-outlined  style=font-center">meeting_room</span>
                  <span class="<?= strpos($requestUri, 'login-orsospol') || strpos($requestUri, 'login-pegawai') ? 'teksactive' : '' ?>">Login</span></a>
                <ul class="dropdown-menu dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
                  <li><a class="dropdown-item" href="/login-orsospol">Login Orsospol</a></li>
                  <li><a class="dropdown-item" href="/login-pegawai">Login Pegawai</a></li>
                  <li><a class="dropdown-item" href="/login-publik">Login Publik</a></li>
                </ul>
              </div>
            </li>
          <?php } ?>
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p class="text-center hubungiteks"><i class="fas fa-phone"></i> <i class="fas fa-phone"></i> (022) 1234 5678</p>
      </div>
