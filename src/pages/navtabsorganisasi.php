...
<div class="container px-0 my-3 rounded justify-content-start">
  <div class="row text-center d-flex align-items-center mx-1" id="latar">
    <div class="col-3 p-2">
      <a class="nav-link p-0 fw-bold" aria-current="page" href="\ormas" id="fsorganisasi">
